...
public class SaleServlet extends HttpServlet {
	...
	private void getallclassify(HttpServletRequest request, HttpServletResponse response,Jedis jedis) throws IOException {
	...
	private void goods(HttpServletRequest request, HttpServletResponse response,Jedis jedis) throws IOException {
